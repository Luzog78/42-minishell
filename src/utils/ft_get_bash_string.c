...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_get_bash_string.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: ysabik <ysabik@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/01 00:37:18 by bcarolle          #+#    #+#             */
/*   Updated: 2024/02/17 08:23:35 by ysabik           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*ft_bash_finish(char *bash_string, int size)
{
	bash_string[size] = '\0';
...
char	*ft_get_bash_string(char *str, char **env, t_bool keep_quotes)
{
	...
	return (ft_bash_finish(bash_string, size));
}
